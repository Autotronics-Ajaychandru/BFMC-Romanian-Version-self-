...
# --- LOCALIZATION ---
# Sensor-driven EKF (bicycle + IMU predict; lane + map Joseph updates). Mission path
# tightens map matching; without a path, nearest graph edge is used. Set False for
# legacy path-interpolation / magnetic map pose.
USE_FUSED_LOCALIZATION = True

# Correlate YOLO / traffic labels with map path signs for occasional xy EKF updates.
USE_SEMANTIC_LANDMARKS = True
